/** The main chat pane: message list, day dividers, pinned messages, composer,
 *  and the game-invitation cards + overlay for the active room. */
...
import MutedUsersPanel from "../ui/MutedUsersPanel";
import BannedUsersPanel from "../ui/BannedUsersPanel";
import GameInvitationCard from "../games/GameInvitationCard";
